...
public class ButtonGradient extends JButton {
    ...
    private Color color2 = MyColorSet.buttonColor;
    ...
    public ButtonGradient() {
        ...
        setForeground(MyColorSet.buttonFontColor);
    ...
    private void createStyle(Graphics2D g2) {
        ...
        int width = getWidth();
        int height = getHeight();
        GradientPaint gra = new GradientPaint(0, 0, MyColorSet.buttonColor1, 0, height, new Color(255, 255, 255, 60));
        g2.setPaint(gra);
    ...
    private void paintPressed(Graphics2D g2) {
        ...
        g2.setColor(MyColorSet.buttonColor1);
