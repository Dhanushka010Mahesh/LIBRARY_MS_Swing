...
public class MyColorSet {
    ...
    public static Color buttonColor=Color.decode("#fc00ff"); //right side button color
    public static Color buttonColor1=Color.decode("#ffff1c");
    ...
    public static Color menuItemspnl=Color.WHITE;
}
